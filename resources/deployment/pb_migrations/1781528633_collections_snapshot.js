/// <reference path="../pb_dataa/types.d.ts" />
migrate(
  (app) => {
    const snapshot = [
      {
      ...
      },
      {
        ...
        id: 'zd5u2s0odf28ljg',
        indexes: ['CREATE UNIQUE INDEX `idx_IcpzmJs` ON `tags` (`name`)'],
        listRule: '',
        name: 'tags',
        system: false,
        type: 'base',
      ...
      {
        createRule:
          '@request.auth.id != "" && @request.auth.verified = true && @request.auth.id = @request.body.creator.id',
        ...
        fields: [
          ...
          },
          {
            ...
            required: false,
            system: false,
            thumbs: ['300x200', '600x400', '1200x800'],
            type: 'file',
          },
          {
            cascadeDelete: false,
