...
export const BLUEPRINT_IMAGE_TYPES = ['image/jpeg', 'image/png', 'image/gif'] as const;
...
const BLUEPRINT_TITLE_SCHEMA = z
	...
	.regex(BLUEPRINT_TITLE_REGEX, 'String must only contain these characters: "A-Za-z0-9_-"');
...
const BLUEPRINT_TAGS_SCHEMA = z
	.string()
	.regex(BLUEPRINT_TAGS_REGEX, 'String must only contain these characters: "A-Za-z0-9_-"')
	.refine(
