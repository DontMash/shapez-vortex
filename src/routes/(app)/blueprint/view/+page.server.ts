  ...
  try {
    ...
    return {
      seo: {
        ...
        description:
          "View and interact with the 3D visualization of a blueprint. Explore the blueprints's multiple layers and parts.",
