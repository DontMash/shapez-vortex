...
import { encode, type Blueprint } from '@shapez-vortex/blueprint';
import { GAME_VERSION } from '@shapez-vortex/game-data';

import type { BlueprintIdentifier } from './blueprint';
import {
  BLUEPRINT_SCHEMA,
...
const generatedMockBlueprintIdentifier = encode(
  mockBlueprint,
  BLUEPRINT_SCHEMA,
);

const mockBlueprintIdentifier: BlueprintIdentifier =
  generatedMockBlueprintIdentifier as BlueprintIdentifier;
